...
def test_get_function_startlineno_and_relativelineno_from_function_definition_id(session, exception_stack_line):
    start_line_number, relative_line_number = get_function_startlineno_and_relativelineno_from_function_definition_id(session, exception_stack_line.function_definition_id, exception_stack_line.stack_trace_snapshot_id, exception_stack_line.position)
...
def test_get_function_startlineno_and_relativelineno_from_invalid_id(session):
    result = get_function_startlineno_and_relativelineno_from_function_definition_id(session, -1, -1, 0)
