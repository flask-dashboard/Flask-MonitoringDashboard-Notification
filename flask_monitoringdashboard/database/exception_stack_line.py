...
def add_exception_stack_line(session, stacktrace_snapshot_id, position, code_line: CodeLine, function_defintion_id, relative_lineno):
    """
    ...
    session.add(
        ExceptionStackLine(
            stacktrace_snapshot_id=stacktrace_snapshot_id,
            position=position,
