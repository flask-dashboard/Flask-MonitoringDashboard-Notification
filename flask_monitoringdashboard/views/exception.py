...
@blueprint.route('/api/function_definition/<int:function_id>/<int:stacktrace_snapshot_id>')
@secure
def get_function_definition_for_exception(function_id, stacktrace_snapshot_id):
    """
    ...
    with session_scope() as session:
        definition = get_exception_function_definition(session, function_id, stacktrace_snapshot_id)
