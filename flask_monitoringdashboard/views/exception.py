...
@blueprint.route('/api/function_definition/<int:function_id>/<int:stack_trace_snapshot_id>/<int:position>')
@secure
def get_function_definition_for_exception(function_id, stack_trace_snapshot_id, position):
    """
    ...
    with session_scope() as session:
        definition = get_exception_function_definition(session, function_id, stack_trace_snapshot_id, position)
